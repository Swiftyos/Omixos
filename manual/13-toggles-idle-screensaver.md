...
These user-state toggles are retained by the Quattro shell. Suspend, lock,
screen recording, and hardware-specific toggles still require target
validation; the graphical ARM VM is not physical Pi/M2 evidence.
