...
Screenshot and shell capture paths are covered by the graphical ARM VM. Screen
recording/webcam support is optional and disabled in the Pi profile unless a
host explicitly enables a compatible package; do not infer GPU recording
support from the upstream menu.
